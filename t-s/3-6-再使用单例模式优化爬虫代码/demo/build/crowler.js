...
var Crowler = /** @class */ (function () {
    function Crowler(url, analyzer) {
        ...
        this.path = path_1.default.resolve(__dirname, '../data/course.json');
        this.initSpiderProcess();
    }
    Crowler.prototype.getRawHtml = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        html = _a.sent();
                        result = this.analyzer.analyze(html, this.path);
...
var analyzer = dellAnalyzer_1.default.CreateInstance();
